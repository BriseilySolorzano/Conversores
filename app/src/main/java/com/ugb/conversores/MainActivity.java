...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tbh.addTab(tbh.newTabSpec("TRA").setContent(R.id.tabTransferenciaDeDatos).setIndicator("Datos",null));
        tbh.addTab(tbh.newTabSpec("TEM").setContent(R.id.tabTemperatura).setIndicator("Temperatura",null));
        ...
        btn=findViewById(R.id.btnConvertirTemperatura);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v){
                spn=findViewById(R.id.spnADeTemperatura);
                int de = spn.getSelectedItemPosition();
                spn=findViewById(R.id.spnDeTemperatura);
                int a =spn.getSelectedItemPosition();
                tempVal=findViewById(R.id.txtCantidadTemperatura);
                double cantidad = Double.parseDouble(tempVal.getText().toString());
                double respuesta = miObj.convertir(7,de,a,cantidad);
                Toast.makeText(getApplicationContext(), "Respuesta:"+ respuesta, Toast.LENGTH_SHORT).show();
            }
        });
